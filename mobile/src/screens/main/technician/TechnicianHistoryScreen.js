...
/**
 * TechnicianHistoryScreen - Screen for showing completed and cancelled tasks.
 */
const TechnicianHistoryScreen = () => {
  const navigation = useNavigation();
  const { history, loading, refreshing, onRefresh } = useTechnicianHistory();
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>سجل المهام</Text>
        <View style={{ width: 44 }} />
      </View>
        ...
        <FlatList 
          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
               ...
               <Text style={styles.emptySub}>لم تقم بإتمام أي مهام بعد. ابدأ العمل لتظهر أعمالك هنا</Text>
            </View>
          }
        />
      )}
